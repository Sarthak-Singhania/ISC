...
x={"sports_name":"Badminton","slot":"5:00pm-6:00pm","Bookings":{"2022-02-21":{"Tushar Mishra":"tm217@snu.edu.in"},"2022-02-22":{"Tushar Mishra":"tm217@snu.edu.in","Sarthak Singhania ":"ss878@snu.edu.in"},"2022-02-23":{"Tushar Mishra":"tm217@snu.edu.in"}},"Check":{"tm217@snu.edu.in":["2022-02-21","2022-02-22","2022-02-23"],"ss878@snu.edu.in":["2022-02-22"]}}
...
def checking(check):
    ...
    for i in check:
        ...
        dates=[str(ll['Date']) for ll in cur.fetchall()]
